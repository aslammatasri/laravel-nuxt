...
const navItems = [
  ...
  { label: 'Applications',   icon: 'applications',   to: '/creator/applications'   },
  { label: 'Collaborations', icon: 'collaborations', to: '/creator/collaborations' },
  ...
  <div class="min-h-screen bg-gray-50 flex">
    ...
    <aside class="w-64 bg-white border-r border-gray-100 flex flex-col fixed h-full">
      ...
      <div class="px-6 py-5 border-b border-gray-100">
        ...
        <span class="ml-2 text-xs bg-green-100 text-green-700 px-2 py-0.5 rounded-full font-medium">Creator</span>
      </div>
    ...
    <main class="flex-1 ml-64">
      <header class="sticky top-0 z-10 bg-white border-b border-gray-100 px-8 py-4 flex justify-end">
        <NotificationBell />
      </header>
      <div class="p-8">
        <slot />
