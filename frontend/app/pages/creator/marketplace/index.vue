...
const { data: products, refresh } = await useAsyncData("marketplace", () =>
    $api<Paginated<Product>>("/creator/marketplace", { params: filters }).catch(
        () => null,
    ),
);
    ...
    <div class="mp-page">
        ...
        <div class="flex items-center justify-between mb-6">
            ...
            >
                <span>🔍</span>
                Filters
                <span v-if="activeFilterCount()" class="mp-filter-badge">{{
                    activeFilterCount()
                }}</span>
                <span
                    class="mp-toggle-chevron"
                    :class="{ 'mp-chevron-open': showFilters }"
                    >▾</span
                >
            </button>
        </div>
            ...
            <div v-if="showFilters" class="mp-filters">
                <div class="mp-filters-grid">
                    ...
                    <div class="mp-filter-group">
                        ...
                        <input
                            v-model="filters.min_commission"
                            type="number"
                            min="0"
                            placeholder="0"
                            class="mp-input"
                    ...
                    <div class="mp-filter-group">
                        ...
                        <input
                            v-model="filters.max_commission"
                            type="number"
                            min="0"
                            placeholder="100"
                            class="mp-input"
                ...
                <div v-if="hasActiveFilters()" class="mp-chips">
                    <span
                        ...
                        class="mp-chip mp-chip-removable"
                    >
                        {{ filters.category }}
                        <button
                    ...
                    <span
                        v-if="filters.commission_type"
                        class="mp-chip mp-chip-removable"
                    >
                        {{
                            filters.commission_type === "percentage"
                                ? "%"
                                : "RM"
                        }}
                        <button
                            @click="filters.commission_type = ''"
                            class="mp-chip-x"
                        >
                            ✕
                        </button>
        ...
        <div v-else class="mp-grid">
            ...
            >
                ...
                <div class="mp-card-img-wrap">
                    ...
                    <div
                        class="mp-card-badge"
                        :class="commissionColor(product.commission_rate)"
                    >
