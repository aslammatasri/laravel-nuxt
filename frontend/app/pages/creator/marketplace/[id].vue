    ...
    <div class="max-w-3xl">
        <div class="mb-6">
            <NuxtLink
                ...
                class="text-sm text-gray-400 hover:text-gray-600 block mb-2"
            >
                ← Back to marketplace
            </NuxtLink>
        </div>
        ...
        <div v-if="product" class="space-y-6">
            ...
            >
                <div
                    class="relative bg-gray-100 h-64 flex items-center justify-center overflow-hidden select-none"
                >
                    <template v-if="product.images?.length">
                        ...
                        <button
                            ...
                            "
                            class="absolute left-2 top-1/2 -translate-y-1/2 bg-white/80 hover:bg-white rounded-full w-8 h-8 flex items-center justify-center shadow text-sm transition-colors"
                        >
                            ‹
                        </button>
                        <button
                            ...
                            @click="
                                activeSlide =
                                    activeSlide < product.images.length - 1
                                        ...
                                        : 0
                            "
                            class="absolute right-2 top-1/2 -translate-y-1/2 bg-white/80 hover:bg-white rounded-full w-8 h-8 flex items-center justify-center shadow text-sm transition-colors"
                        >
                            ›
                        </button>
                        <!-- Dots -->
                ...
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                        ...
                        <div class="bg-gray-50 rounded-xl p-3 text-center">
                            ...
                            <p class="font-semibold text-gray-900 text-sm">
                                {{ formatDate(product.campaign_end) }}
                            </p>
                        </div>
                        <div class="bg-gray-50 rounded-xl p-3 text-center">
                    ...
                    >
                        ...
                        <div class="space-y-4">
                            ...
                            >
                                <p
                                    class="text-xs text-gray-400 font-medium uppercase tracking-wide mb-2"
                                >
                                    {{ variation.name }}
                                </p>
            ...
            <div class="bg-white rounded-2xl border border-gray-100 p-6">
                ...
                <div v-if="success" class="text-center py-8">
                    ...
                    <p class="text-gray-500 text-sm mb-6">
                        The brand will review your application and get back to
                        you soon.
                    </p>
                ...
                <div v-else>
                    ...
                    <p class="text-sm text-gray-400 mb-5">
                        Tell the brand why you are the right creator for this
                        product
                    </p>

                    <div
                        v-if="error"
                        class="bg-red-50 text-red-600 text-sm rounded-xl p-4 mb-5"
                    >
                        {{ error }}
                    </div>
