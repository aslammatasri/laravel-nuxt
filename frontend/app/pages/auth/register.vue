...
const role = computed(() => route.query.role as 'creator' | 'brand' || 'creator')
...
const btnClass = computed(() => isBrand.value ? 'rg-btn-brand' : 'rg-btn-creator')
  ...
  <div class="rg-page">
    ...
    <div class="rg-inner">
      ...
      <div class="rg-header">
        ...
        <p class="rg-sub">
          Wrong type?
          <NuxtLink to="/auth/register-type" class="rg-link">Go back</NuxtLink>
        </p>
      </div>
      ...
      <div class="rg-card">
        ...
        <div class="rg-field-group" @keydown="handleKeydown">
          ...
          <button
            ...
            class="rg-btn"
            :class="[btnClass, { 'rg-btn-loading': authStore.isLoading }]"
          >
            <span v-if="authStore.isLoading" class="rg-spinner"></span>
