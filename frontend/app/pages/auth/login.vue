    ...
    <div class="lg-inner">
      ...
      <div class="lg-card">
        ...
        <div class="lg-field-group" @keydown="handleKeydown">
          ...
          <div class="lg-field">
            <div style="display:flex;justify-content:space-between;align-items:center;">
              ...
              <NuxtLink to="/auth/forgot-password" class="lg-link" style="font-size:0.78rem;">Forgot password?</NuxtLink>
            </div>
            <div class="lg-input-wrap">
              <span class="lg-input-icon">🔒</span>
              <input
          ...
          >
            <span v-if="authStore.isLoading" class="lg-spinner"></span>
        ...
        <p class="lg-footer-text">
          ...
          <NuxtLink to="/auth/register-type" class="lg-link">Sign up</NuxtLink>
        </p>
      </div>
